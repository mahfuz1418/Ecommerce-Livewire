                            ...
                            <div class="row mb-50">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        <h2 class="title-detail">{{ $product_details->name }}</h2>
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span
                                                        class="text-brand">${{ $product_details->selling_price }}</span></ins>
                                                <ins><span
                                                        class="old-price font-md ml-15">${{ $product_details->regular_price }}</span></ins>
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="submit" class="button button-add-to-cart"
                                                    wire:click="addToCart({{ json_encode([
                                ...
                                <div class="col-12">
                                    <div class="row related-products">
                                        @foreach ($related_products as $rproduct)
                                            <div class="col-lg-3 col-md-4 col-12 col-sm-6 my-2">
                                                <div class="product-cart-wrap small hover-up">
                                                    <div class="product-img-action-wrap">
                                                        <div class="product-img product-img-zoom">
                                                            <a href="product-details.html" tabindex="0">
                                                                <img class="default-img" src="{{ $rproduct->image }}"
                                                                    alt="">
                                                                <img class="hover-img" src="{{ $rproduct->image }}"
                                                                    alt="">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="product-content-wrap">
                                                        ...
                                                        <div class="product-price">
                                                            <span>${{ $rproduct->selling_price }} </span>
                                                            <span
