                            ...
                            <div class="sort-by-product-area">
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $perPage == 12 ? 'active' : '' }}"
                                                    wire:click.prevent='productPerPage(12)'>12</a></li>
                                            <li><a class="{{ $perPage == 24 ? 'active' : '' }}"
                                                    wire:click.prevent='productPerPage(24)'>24</a></li>
                                            <li><a class="{{ $perPage == 36 ? 'active' : '' }}"
                                                    wire:click.prevent='productPerPage(36)'>36</a></li>
                                            <li><a class="{{ $perPage == 48 ? 'active' : '' }}"
                                                    wire:click.prevent='productPerPage(48)'>48</a></li>
                                            <li><a class="{{ $perPage == 60 ? 'active' : '' }}"
                                                    wire:click.prevent='productPerPage(60)'>60</a></li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $orderBy == 'Default Sorting' ? 'active' : '' }}"
                                                    wire:click.prevent="orderedBy('Default Sorting')">Default
                                                    Sorting</a></li>
                                            <li><a class="{{ $orderBy == 'Price: Low to High' ? 'active' : '' }}"
                                                    wire:click.prevent="orderedBy('Price: Low to High')">Price: Low to
                                                    High</a></li>
                                            <li><a class="{{ $orderBy == 'Price: High to Low' ? 'active' : '' }}"
                                                    wire:click.prevent="orderedBy('Price: High to Low')">Price: High to
                                                    Low</a></li>
                                            <li><a class="{{ $orderBy == 'Newest Product' ? 'active' : '' }}"
                                                    wire:click.prevent="orderedBy('Newest Product')">Newest Product</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="price-filter-inner">
                                    ...
                                    <div class="price_slider_amount">
                                        <div class="label-input">
                                            <span>Range:</span><span>${{ $min_price }}</span>-
                                            <span>${{ $max_price }}</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            @foreach ($nproducts as $nproduct)
                                <div class="single-post clearfix">
                                    <div class="image">
                                        <img src="{{ asset($nproduct->image) }}" alt="#">
                                    </div>
                                    <div class="content pt-10">
                                        <h5><a href="product-details.html">{{ $nproduct->name }}</a></h5>
                                        <p class="price mb-0 mt-5">${{ $nproduct->selling_price }}</p>
